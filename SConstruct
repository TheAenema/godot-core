...
opts.Add("vsproj_name", "Name of the Visual Studio solution", "godot-core")
...
env["builtin_certs"] = False
env["builtin_mbedtls"] = False
env["builtin_libpng"] = True
env["builtin_glslang"] = True
env["module_jpg_enabled"] = False
env["builtin_rvo2_2d"] = False
env["builtin_rvo2_3d"] = False
env["builtin_msdfgen"] = False
env["builtin_msdfgen"] = False
